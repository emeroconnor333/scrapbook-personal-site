...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${playfair.variable} h-full`}>
      <body className="h-full flex flex-col pt-6" style={{backgroundImage:"repeating-linear-gradient(0deg,transparent,transparent 19px,rgba(251,207,232,0.4) 19px,rgba(251,207,232,0.4) 20px),repeating-linear-gradient(90deg,transparent,transparent 19px,rgba(251,207,232,0.4) 19px,rgba(251,207,232,0.4) 20px)",backgroundColor:"#fffbeb"}}>
        <header className="bg-rose-300 px-6 py-1.5 flex items-center justify-between shadow-sm shrink-0">
          <Link href="/" className="font-playfair text-xl font-semibold text-white tracking-wide hover:text-rose-100 transition-colors">
            Emer O&apos;Connor
          </Link>
